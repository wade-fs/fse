...
→ **Pattern**: [Discovery Loop](../patterns/Discovery-Loop.md) — Discovery 的循環結構設計模式

→ **ADR**: [ADR-0003 Discovery-First Progression](../adr/ADR-0003-Discovery-First-Progression.md) — 為什麼 Progress 由 Discovery 驅動

→ **Adventure**: [Programming World](../adventures/Programming-World.md) — Discovery 觸發結構最清晰的實例
