...
→ **Philosophy**: [09-Runtime](../philosophy/09-Runtime.md) — 哲學思維與 Runtime 實作邊界的關係

→ **ADR**: [ADR-0007 Adventure Laboratory](../adr/ADR-0007-Adventure-Laboratory.md) — PW 作為驗證環境的核心決策

→ **Adventure**: [Programming-World](../adventures/Programming-World.md) — 程式世界的實作設計
